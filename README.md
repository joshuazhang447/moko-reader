...
![Book Reading Mode](https://i.imgur.com/FePl527.png)

<div align="center">
  <!-- PASTE IMAGE LINK 3 HERE (e.g., Comic Reading Dark Mode) -->
  <img src="https://i.imgur.com/qN8zHGN.png" width="45%" alt="Comic Mode" />
  <!-- PASTE IMAGE LINK 4 HERE (e.g., Folder/Category View) -->
  <img src="https://i.imgur.com/rFn0TnH.png" width="45%" alt="Folder View" />
</div>
...
*   **Zoom & Scaling:**
    *   Adjust font and page sizes via UI controls.
...
*   **Search Functionality:**
    ...
    *   **Scoped Search:** Search specifically within folders/categories.
*   **Library Refresh:** Detects new files added to your source folders with a single click.
...
*   All text-based books shown are in the **Public Domain**.
*   All comic imagery is used strictly for demonstration purposes under **Fair Use**. Only limited preview pages are accessible, and the remainder of the content has been omitted.
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/joshuazhang447/moko-reader.git
    ```
